...
const argsSchema = [
    ...
    ['omit-folder', ['Temp/', 'test/']], // Folders to omit when getting a list of files to update (TODO: This may be obsolete now that we get a list of files from github itself.) 'test/' holds Node-only test files that the game never runs.
];
